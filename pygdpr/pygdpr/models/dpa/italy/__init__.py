...
# TODO: Run recently implemented links overnight to gather all documents
class Italy(DPA):
    ...
    # TODO:Double check the document title and stuff
    ...
    # TODO: Let this run to completion
    ...
    def get_docs_InjunctionsFromLastPage(self, existing_docs=[], overwrite=False, to_print=True):
        print('------------ GETTING INJUNCTIONS (STARTING FROM LAST PAGE) ------------')
        added_docs = []
