...
class Latvia(DPA):
    ...
    def update_pagination(self, pagination=None, page_soup=None, driver=None):
        ...
        if pagination is None:
            ...
            div_pagination = page_soup.find('div', id='pagination')
            if div_pagination is not None:
                for a in div_pagination.find_all('a', class_='page-numbers'):
                    page_link = a
    ...
    def get_docs(self, existing_docs=[], overwrite=False, to_print=True):
        ...
        while pagination.has_next():
            ...
            assert results_soup
            content_part = results_soup.find('div', id='content-part')
            assert content_part
            # s1. Results
            for post in content_part.find_all('div', class_='post'):
                meta = post.find('div', class_='meta')
                assert meta
                strong = meta.find('strong')
                assert strong
                date_str = strong.get_text().strip().rstrip('.')
